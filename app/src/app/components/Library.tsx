            ...
            <div key={idx} className='flex bg-[#b6ccd8] shadow-xl h-48 p-3 rounded'>
              ...
              <div className='flex-grow my-auto px-5'>
                <div className='flex items-center'>
                  ...
                  <h1 className='text-lg font-semibold text-[#00668c] pl-1 uppercase'>Book Title N1</h1>
                </div>
                <div className='flex my-3'>
                  <h1 className='text-base font-medium text-[#313d44] mr-auto'>Shahoo Yousofi</h1>
                  {[...Array(5)].map((_, idx) => (
